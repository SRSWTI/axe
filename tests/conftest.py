...
from axe_cli.config import Config, get_default_config
from axe_cli.llm import ALL_MODEL_CAPABILITIES, LLM
from axe_cli.metadata import WorkDirMeta
from axe_cli.session import Session
from axe_cli.soul.agent import Agent, BuiltinSystemPromptArgs, LaborMarket, Runtime
from axe_cli.soul.approval import Approval
from axe_cli.soul.denwarenji import DenwaRenji
from axe_cli.soul.toolset import AxeToolset
from axe_cli.tools.dmail import SendDMail
from axe_cli.tools.file.glob import Glob
from axe_cli.tools.file.grep_local import Grep
from axe_cli.tools.file.read import ReadFile
from axe_cli.tools.file.read_media import ReadMediaFile
from axe_cli.tools.file.replace import StrReplaceFile
from axe_cli.tools.file.write import WriteFile
from axe_cli.tools.multiagent.create import CreateSubagent
from axe_cli.tools.multiagent.task import Task
from axe_cli.tools.shell import Shell
from axe_cli.tools.think import Think
from axe_cli.tools.todo import SetTodoList
from axe_cli.tools.web.fetch import FetchURL
from axe_cli.tools.web.search import SearchWeb
from axe_cli.utils.environment import Environment
...
def config() -> Config:
    ...
    # Moonshot services removed - using default config
    return conf
...
def builtin_args(temp_work_dir: KaosPath) -> BuiltinSystemPromptArgs:
    ...
    return BuiltinSystemPromptArgs(
        AXE_NOW="1970-01-01T00:00:00+00:00",
        AXE_WORK_DIR=temp_work_dir,
        AXE_WORK_DIR_LS="Test ls content",
        AXE_AGENTS_MD="Test agents content",
        AXE_SKILLS="No skills found.",
    )
...
def tool_call_context(tool_name: str) -> Generator[None]:
    ...
    from axe_cli.soul.toolset import current_tool_call
    from axe_cli.wire.types import ToolCall
...
@pytest.fixture
def create_subagent_tool(toolset: AxeToolset, runtime: Runtime) -> CreateSubagent:
