...
from axe_cli.agentspec import DEFAULT_AGENT_FILE, load_agent_spec
from axe_cli.exception import AgentSpecError
...
def test_load_default_agent_spec():
    ...
    assert spec.tools == snapshot(
        ["axe_cli.tools.multiagent:Task", "axe_cli.tools.multiagent:CreateSubagent", "axe_cli.tools.todo:SetTodoList", "axe_cli.tools.shell:Shell", "axe_cli.tools.file:ReadFile", "axe_cli.tools.file:ReadMediaFile", "axe_cli.tools.file:Glob", "axe_cli.tools.file:Grep", "axe_cli.tools.file:WriteFile", "axe_cli.tools.file:StrReplaceFile", "axe_cli.tools.axe:CodeSearch", "axe_cli.tools.axe:CodeContext", "axe_cli.tools.axe:CodeStructure", "axe_cli.tools.axe:CodeImpact"]
    )
    subagents = {
    ...
    assert subagent_specs["coder"].exclude_tools == snapshot(
        [
            ...
            "axe_cli.tools.dmail:SendDMail",
            "axe_cli.tools.todo:SetTodoList",
        ]
    )
...
def test_load_agent_spec_basic(agent_file: Path):
    ...
    assert spec.tools == snapshot(["axe_cli.tools.think:Think"])
...
def test_load_agent_spec_with_exclude_tools(agent_file_with_tools: Path):
    ...
    assert spec.tools == snapshot(["axe_cli.tools.think:Think", "axe_cli.tools.shell:Shell"])
    assert spec.exclude_tools == snapshot(["axe_cli.tools.shell:Shell"])
...
""")
        ...
        assert spec.exclude_tools == snapshot(
            ["axe_cli.tools.web:SearchWeb", "axe_cli.tools.web:FetchURL"]
        )
...
agent:
  ...
  tools: ["axe_cli.tools.think:Think"]
""")
...
agent:
  name: "Test Agent"
  system_prompt_path: ./system.md
  tools: ["axe_cli.tools.think:Think", "axe_cli.tools.shell:Shell"]
  exclude_tools: ["axe_cli.tools.shell:Shell"]
""")
