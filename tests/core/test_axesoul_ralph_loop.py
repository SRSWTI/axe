...
from axe_cli.llm import LLM, ModelCapability
from axe_cli.soul import run_soul
...
from axe_cli.utils.aioqueue import QueueShutDown
from axe_cli.wire import Wire
from axe_cli.wire.types import TurnBegin
...
def _make_soul(
    ...
    return AxeSoul(agent, context=context), context


async def _run_and_collect_turns(
    soul: AxeSoul, user_input: str | list[ContentPart]
