...
from axe_cli.wire.file import WireFileMetadata, WireMessageRecord
from axe_cli.wire.protocol import WIRE_PROTOCOL_VERSION
from axe_cli.wire.types import TextPart, TurnBegin
...
def isolated_share_dir(monkeypatch, tmp_path: Path) -> Path:
    ...
    monkeypatch.setattr("axe_cli.share.get_share_dir", _get_share_dir)
    monkeypatch.setattr("axe_cli.metadata.get_share_dir", _get_share_dir)
    return share_dir
