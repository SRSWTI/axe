...
from axe_cli.skill import Skill
from axe_cli.skill.flow import Flow, FlowEdge, FlowNode
...
def test_flow_skill_registers_skill_and_flow_commands(runtime: Runtime, tmp_path: Path) -> None:
    ...
    soul = AxeSoul(agent, context=Context(file_backend=tmp_path / "history.jsonl"))
