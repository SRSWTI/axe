        ...
        assert normalize_response(resp) == snapshot(
            {
                "result": {
                    ...
                    "server": {"name": "axe Code CLI", "version": "<VERSION>"},
                    "slash_commands": [
                        {
                            "name": "init",
                        ...
                        },
                        {
                            ...
                            "description": "Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends Axe's capabilities with specialized knowledge, workflows, or tool integrations.",
                            "aliases": [],
                        },
                    ],
                }
